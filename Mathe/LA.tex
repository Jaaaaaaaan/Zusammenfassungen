...
\item cos$(\alpha)=\dfrac{u\bullet v}{\Vert u \Vert \cdot \Vert v\Vert}$ mit $\alpha\in [0,2\pi]$!!$\;\;\;\; u \bullet v=0 \Leftrightarrow u\perp v$ $\;\;\;\;v$ ist \textbf{Einheitsvektor} wenn $\Vert v \Vert=v\bullet v=1$
...
\subsection{Orthogonal- und Orthonormalbasen (OGB/ONB), Gram-Schmidt-Verfahren }
\begin{itemize}
